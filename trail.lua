...
local PROJECTILE_TRAIL = {red = 253, green = 106, blue = 2, alpha = 200, thickness = 40} -- RGBA and thickness
local HYDRA_TRAIL = {red = 0, green = 0, blue = 255, alpha = 200, thickness = 40}
